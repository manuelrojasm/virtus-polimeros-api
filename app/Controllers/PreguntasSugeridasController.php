...
class PreguntasSugeridasController extends ResourceController
{
    ...
    #[OA\Get(
        ...
        summary: "Obtener preguntas sugeridas para el curso a partir del resumen de sus PDFs",
        description: "Une el resumen de todas las secciones (PDFs) del curso y llama a Claude para generar al menos 15 preguntas sugeridas. El JSON puede mostrarse en el front para que el usuario las edite y luego guarde con POST /preguntas asociándolas al curso.",
        parameters: [
        ...
        responses: [
            new OA\Response(
                response: 200,
                description: "Preguntas sugeridas para el curso, listas para enviar a POST /preguntas",
            ...
            new OA\Response(response: 500, description: "ANTHROPIC_API_KEY no configurada o error del servicio"),
        ]
    )]
    public function index($idCurso = null)
    {
        ...
        try {
            ...
            if (strpos($message, 'ANTHROPIC_API_KEY') !== false) {
                return $this->fail('Servicio de preguntas sugeridas no configurado. Configure ANTHROPIC_API_KEY.', 500);
            }
